...
export const UserContactsComponent: React.FC<UserContactsPropsType> = ({
	profile,
	isOwner,
}) => {
	return (
		<div className='card mb-3 mt-3'>
			<div className='card-body'>
				<div className='row'>
					...
					<div className='col-sm-9 text-secondary'>{profile.fullName}</div>
				</div>
				<hr />
				<div className='row'>
					<div className='col-sm-3'>
					...
					<div className='col-sm-9 text-secondary'>{profile.aboutMe}</div>
				</div>
				<hr />
				<div className='row'>
					<div className='col-sm-3'>
